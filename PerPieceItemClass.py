...
class PerPieceItem:
	...
	def __init__(self, event_id):
		...
		self.price_per_pack = ""
		self.pieces_per_pack = ""
		self.pieces_per_person = ""
		self.packs_needed = ""
		self.raw_cost = ""
	...
	def get_all_items(self):	
		...
		try:
			...
			strSQL = "SELECT * FROM PerPieceItems;"
			...
			for dbRec in dbCurs:
				...
				self.item_DICT["pieces_per_pack"] = dbRec[3]
				self.item_DICT["pieces_per_person"] = dbRec[4]
	...
	def add_item(self):
		...
		try:
			...
			strSQL = "INSERT INTO PerPieceItems (ItemName, PricePerPack, PiecesPerPack, PiecesPerPerson, PacksNeeded, RawCost, EventID) VALUES (" + self.item_name + "," + self.price_per_pack + "," + self.pieces_per_pack + "," + self.pieces_per_person + "," + self.packs_needed + "," + self.raw_cost + "," + event_id + ");"
	...
	def update_item(self):
		...
		try:
			...
			strSQL = "UPDATE PerPieceItems SET ItemName = " + self.item_name + ", PricePerPack = " + self.price_per_pack + ", PiecesPerPack = " + self.pieces_per_pack + ", PiecesPerPerson = " + self.pieces_per_person + ", PacksNeeded = " + self.packs_needed + ", RawCost = " + self.raw_cost + " WHERE ItemID = " + self.item_id + ";"
	...
	def delete_item(self):
		...
		try:
			...
			strSQL = "DELETE FROM PerPieceItems WHERE ItemID = " + self.item_id + ";"
	...
	def get_item(self):	
		...
		try:
			...
			strSQL = "SELECT * FROM PerPieceItems WHERE ItemID = " + self.item_id + ";"
			dbCurs.execute(strSQL)
			...
			for dbRec in dbCurs:
				...
				self.pieces_per_pack = dbRec[3]
				self.pieces_per_person = dbRec[4]
